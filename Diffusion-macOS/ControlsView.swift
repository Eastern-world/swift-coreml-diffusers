            ...
            ScrollView {
                Group {
                    DisclosureGroup(isExpanded: $disclosedModel) {
                        ...
                        HStack {
                            Label("集市上的模型", systemImage: "cpu").foregroundColor(.white)
                            Spacer()
                            if disclosedModel {
                                Button {
                    ...
                    DisclosureGroup(isExpanded: $disclosedPrompt) {
                        ...
                        HStack {
                            Label("文生图提示语句", systemImage: "text.quote").foregroundColor(.white)
                            Spacer()
                            if disclosedPrompt {
                                Button {
                    ...
                    DisclosureGroup(isExpanded: $disclosedGuidance) {
                        ...
                        HStack {
                            Label("指导尺度", systemImage: "scalemass").foregroundColor(.white)
                            Spacer()
                    ...
                    DisclosureGroup(isExpanded: $disclosedSteps) {
                        ...
                        HStack {
                            Label("迭代数量", systemImage: "square.3.layers.3d.down.left").foregroundColor(.white)
                            Spacer()
                            if disclosedSteps {
                                Button {
                    ...
                    DisclosureGroup(isExpanded: $disclosedPreview) {
                        ...
                        HStack {
                            Label("预览迭代数量", systemImage: "eye.square").foregroundColor(.white)
                            Spacer()
                            if disclosedPreview {
                                Button {
                    ...
                    DisclosureGroup(isExpanded: $disclosedSeed) {
                        ...
                        HStack {
                            Label(textFieldLabelSeed, systemImage: "leaf").foregroundColor(.white)
                            Spacer()
                            if disclosedSeed {
                                Button {
                                    showSeedHelp.toggle()
                    ...
                    if Capabilities.hasANE {
                        ...
                        DisclosureGroup(isExpanded: $disclosedAdvanced) {
                            ...
                            HStack {
                                Label("高级", systemImage: "terminal").foregroundColor(.white)
                                Spacer()
